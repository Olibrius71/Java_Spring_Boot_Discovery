...
(function (global, factory) {
    ...
    /**
     * @ Document why this abstraction exists, and the relationship between
    ...
    ***************************************************************************** */
     ...
     * @param {Object} fileContentMap - An object with file contents in 'contents' property (like importManager) @ - move to fileManager?
    ...
    Declaration.prototype = Object.assign(new Node(), {
        ...
        eval: function (context) {
            ...
            // @ remove when parens-division is default
    ...
    ***************************************************************************** */
    ...
    var getParserInput = (function () {
        ...
        //  remove or change some currentChar calls to peekChar
    ...
    function transformTree (root, options) {
         ...
         *
         * @ Add scoping for visitors just like functions for @plugin; right now they're global
         */
        if (options.pluginManager) {
    ...
    function Parse (environment, ParseTree, ImportManager) {
        var parse = function (input, options, callback) {
            ...
            if (!callback) {
                ...
                // : allow the plugins to be just a list of paths or names
    ...
    var logger;
    var fileCache = {};
    // S - move log somewhere. pathDiff and doing something similar in node. use pathDiff in the other browser file for the initial load
    ...
    FileManager.prototype = Object.assign(new AbstractFileManager(), {
        ...
        loadFile: function (filename, currentDirectory, options, environment) {
            // : Add prefix support like less-node?
            ...
            setCSS: function (path, lastModified, modifyVars, styles) {
                if (cache) {
                    ...
                    try {
                        ...
                        //  - could do with adding more robust error handling
